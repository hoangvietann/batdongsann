...
<body>
    <div class="bg-gray-100">
        <div class=" mb-16 mx-5 xl:container xl:mx-auto xl:px-20 ">
                ...
                <div class="splide__track">
                    <ul class="splide__list">
                        <li class="splide__slide">
                            <img src="{{ asset('uploads/1700805095378.jpg') }}" alt="">
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <div class="relative mb-2 shadow-md rounded-md bg-white cursor-pointer">
                <div class="flex justify-start items-start flex-col p-6">
                    <h1 class="block text-[18px] font-bold leading-22 tracking-normal text-start text-[#DC2D27] mb-4 hover:under-line h-[2em]">Nhà mặt phố Nguyễn Chán 85m2 x 5 tầng, mặt tiền 6.5m cho thuê tầng 1, 2</h1>
                    <div class="relative flex items-start w-full">
                        <div class="block max-w-[230px] mr-4 overflow-hidden bg-cover bg-no-repeat">
                            <img src="{{ asset('uploads/1701341207600.jpg') }}" class="w-full h-[150px] rounded-md transition duration-300 ease-in-out hover:scale-105" alt="">
                        </div>
                        
                        <div class="flex flex-col items-start w-full overflow-hidden line-cramp overflow-hidden line-clamp-2">
                            <div class="block mb-5 h-suto">
                                <p class="text-[14px] text-[#898989]">Nhà mặt phố Nguyễn Chánh 85m2 x 5 tầng, mặt tiền 6.5m cho thuê tầng 1,2 Thiết kế thông sàn, có thang máy Vị trí thuận lợi, Mặt phố vỉa...</p>
                            </div>
                            <div class="flex flex-wrap justify-start items-start mb-5">
                                <div class="mr-10 inline-flex items-center">
                                    ...
                                    <span class="text-base font-bold text-[#DC2D27]">
                                        12.3 tỷ
                                    </span>
                                </div>
                                <div class="mr-10 inline-flex items-center">
                                ...
                                <div class="mr-10 inline-flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="5" y="4" width="14" height="17" rx="2" stroke="#333333"/>
                                        <path d="M9 9H15" stroke="#333333" stroke-linecap="round"/>
                                        <path d="M9 13H15" stroke="#333333" stroke-linecap="round"/>
                                        <path d="M9 17H13" stroke="#333333" stroke-linecap="round"/>
                                    </svg>
                                    <span class="text-base text-[#DC2D27]">
                                        Sổ hồng/sổ đỏ
                                    </span>
                                </div>
                                <div class="mr-10 inline-flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 19C15.866 19 19 15.866 19 12C19 8.13401 15.866 5 12 5C8.13401 5 5 8.13401 5 12C5 15.866 8.13401 19 12 19ZM12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" fill="#F2F2F2"/>
                                        <path d="M18.4 12C18.4 15.5346 15.5346 18.4 12 18.4V19.6C16.1974 19.6 19.6 16.1974 19.6 12H18.4ZM12 5.6C15.5346 5.6 18.4 8.46538 18.4 12H19.6C19.6 7.80264 16.1974 4.4 12 4.4V5.6ZM5.6 12C5.6 8.46538 8.46538 5.6 12 5.6V4.4C7.80264 4.4 4.4 7.80264 4.4 12H5.6ZM12 18.4C8.46538 18.4 5.6 15.5346 5.6 12H4.4C4.4 16.1974 7.80264 19.6 12 19.6V18.4ZM14.4 12C14.4 13.3255 13.3255 14.4 12 14.4V15.6C13.9882 15.6 15.6 13.9882 15.6 12H14.4ZM12 9.6C13.3255 9.6 14.4 10.6745 14.4 12H15.6C15.6 10.0118 13.9882 8.4 12 8.4V9.6ZM9.6 12C9.6 10.6745 10.6745 9.6 12 9.6V8.4C10.0118 8.4 8.4 10.0118 8.4 12H9.6ZM12 14.4C10.6745 14.4 9.6 13.3255 9.6 12H8.4C8.4 13.9882 10.0118 15.6 12 15.6V14.4Z" fill="#333333"/>
                                        <path d="M12 5V3" stroke="#333333" stroke-width="1.2" stroke-linecap="round"/>
                                        <path d="M19 12L21 12" stroke="#333333" stroke-width="1.2" stroke-linecap="round"/>
                                        <path d="M12 21L12 19" stroke="#333333" stroke-width="1.2" stroke-linecap="round"/>
                                        <path d="M3 12H5" stroke="#333333" stroke-width="1.2" stroke-linecap="round"/>
                                    </svg>
                                    <span class="text-base">
                                        Cách bạn: <span class="text-[#DC2D27]">2Km</span>
                                    </span>
                                </div>
                            </div>
                            <div class="mb-auto">
                                <span class="text-[15px] text-[#868686]">Đăng hôm nay</span>
                            </div>
                        </div>
                        <a href="#" class="absolute bottom-0 right-0 bg-[#DC2D27] px-6 py-2 rounded-lg text-white uppercase hover:bg-opacity-70">Xem chi tiết</a>
                    </div>
                </div>
                {{-- <a href="" class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed opacity-0 "></a> --}}
            </div>
            <div class="relative mb-2 shadow-md rounded-md bg-white cursor-pointer">
                <div class="flex justify-start items-start flex-col p-6">
                    <h1 class="block text-[18px] font-bold leading-22 tracking-normal text-start text-[#DC2D27] mb-4 hover:under-line h-[2em]">Nhà mặt phố Nguyễn Chán 85m2 x 5 tầng, mặt tiền 6.5m cho thuê tầng 1, 2</h1>
                    <div class="relative flex items-start w-full">
                        <div class="block max-w-[230px] mr-4 overflow-hidden bg-cover bg-no-repeat">
                            <img src="{{ asset('uploads/1701339130784.jpg') }}" class="w-full h-[150px] rounded-md transition duration-300 ease-in-out hover:scale-105" alt="">
                        </div>
